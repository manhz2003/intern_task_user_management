...
public class DateUtil {
    ...
    public static String getUnFormattedDateStr(String formattedDate) {
        ...
        try {
			...
			log.error("getUnFormattedDateStr(String)", e); //$NON-NLS-1$
        }
    ...
    public static Date getUnFormattedDate(String formattedDate) {
        ...
        try {
			...
			log.error("getUnFormattedDate(String)", e); //$NON-NLS-1$
        }
        return date;
    }
    ...
    public static String getUnFormattedMonthStr(String formmatedDate) {
        ...
        try {
			...
			log.error("getUnFormattedMonthStr(String)", e); //$NON-NLS-1$
        }
        return unFormattedDate;
    }
    ...
    public static String getFormattedTimeStr(String HHmm) {
        ...
        try {
			...
			log.error("getFormattedTimeStr(String)", e); //$NON-NLS-1$
        }
        return formattedDate;
    }
    ...
    public static String getUnFormattedTimeStr(String formmatedTime) {
        ...
        try {
			...
			log.error("getUnFormattedTimeStr(String)", e); //$NON-NLS-1$
        }
...
// 		log.debug(" DateHandler.getDiffTime. _fromDate:["  + _fromDate + "] _fromTime:["  + _fromTime + "] _toDate:[" + _toDate + "] _toTime:[" + _toTime + "]");
    ...
    public static int getDiffDay(String s, String s1) {
        try {
			...
			log.error("getDiffDay(String, String)", e); //$NON-NLS-1$
            return 0;
        }
    }
...
//        }
		...
		if (log.isInfoEnabled()) {
			log.info("main(String[]) - strDate=" + strDate); //$NON-NLS-1$
		}
		
		String strOrg = "2002-09-20";
		Date dtNew = DateUtil.getDateWithDelimiter(strOrg, '-' );
		if (log.isInfoEnabled()) {
			log.info("main(String[]) - dtNew=" + dtNew.toString()); //$NON-NLS-1$
		}
    }
