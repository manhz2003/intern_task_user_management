...
public class MessageType {
	...
	public static final int TAU_VAO_6 = 6;
	public static final int TAU_RA_7 = 7;
	public static final int VAO_CANG = 6;
	public static final int ROI_CANG = 7;
	...
	public static final int[] DOCUMENT_TYPE = new int[] { NHAP_CANH, XUAT_CANH, QUA_CANH, TAU_VAO, TAU_RA,
			NHAP_CANG_DAU_KHI, XUAT_CANG_DAU_KHI, VAO_CANG_DAU_KHI, ROI_CANG_DAU_KHI, CHUYEN_CANG_VAO, CHUYEN_CANG_ROI,
			TAU_VAO_PTTND, TAU_RA_PTTND, PTTND_NHAP_CANH, PTTND_XUAT_CANH, VAO_CANG, ROI_CANG };
	...
	public static final int XAC_BAO_TAU_ROI_CANG = 41; // NoticeShipType = 2, ko
														// co xac bao tau roi
														// cang
	...
	public static final int TYPE_TICH_HOP_KE_TOAN_VIET_DA = 96;
	public static final String SyncRequestInvoice = "RequestInvoice";
	public static final String SyncRequestTransactionList = "RequestTransactionList";
	public static final String SyncResponseInvoice = "ResponseInvoice";
	public static final String SynchResponseTransactionList = "ResponseTransactionList";
	...
	// DONG BO DANH MUC MOI CHO PMCV
	public static final int DONG_BO_DM_VMA_TUGBOAT_COMPANY = 200;
	public static final int DONG_BO_DM_HISTORY_TUGBOAT_COMPANY = 201;
	public static final int DONG_BO_DM_VMA_TUGBOAT = 202;
	public static final int DONG_BO_DM_HISTORY_TUGBOAT = 203;
	public static final int DONG_BO_DM_VMA_PILOT_COMPANY = 204;
	public static final int DONG_BO_DM_HISTORY_PILOT_COMPANY = 205;
	public static final int DONG_BO_DM_VMA_PILOT = 206;
	public static final int DONG_BO_DM_HISTORY_PILOT = 207;
	public static final int DONG_BO_DM_VMA_PILOT_CATEGORY = 208;
	public static final int DONG_BO_DM_HISTORY_PILOT_CATEGORY = 209;
	public static final int DONG_BO_DM_VMA_SHIP_OWNER = 210;
	public static final int DONG_BO_DM_HISTORY_SHIP_OWNER = 211;
	public static final int DONG_BO_DM_VMA_SHIPYARD = 212;
	public static final int DONG_BO_DM_HISTORY_SHIPYARD = 213;
	public static final int DONG_BO_DM_VMA_SECURITY_OFFICE = 214;
	public static final int DONG_BO_DM_HISTORY_SECURITY_OFFICE = 215;
	public static final int DONG_BO_DM_VMA_SHIP_TYPE = 216;
	public static final int DONG_BO_DM_HISTORY_VMASHIP_TYPE = 217;
	public static final int DONG_BO_VMA_PILOT_VIOLATION = 218;
	public static final int DONG_BO_VMA_SHIP = 219;
	public static final int DONG_BO_VMA_SHIP_CERTIFICATE = 220;
	public static final int DONG_BO_VMA_ITINERARY = 221;
	public static final int DONG_BO_VMA_ITINERARY_SCHEDULE = 222;
	public static final int DONG_BO_VMA_SCHEDULE_TUGBOAT = 223;
	public static final int DONG_BO_VMA_SCHEDULE_PILOT = 224;
	public static final int DONG_BO_VMA_SCHEDULE_SHIFTING = 225;
	public static final int DONG_BO_VMA_SCHEDULE_ANCHORAGE = 226;
	public static final int DONG_BO_VMA_SCHEDULE_SECURITY = 227;
	public static final int DONG_BO_VMA_SCHEDULE_SHIPYARD = 228;
	public static final int DONG_BO_VMA_SCHEDULE_LAUNCHING = 229;
	public static final int DONG_BO_VMA_SCHEDULE_TESTING = 230;
	public static final int DONG_BO_VMA_SCHEDULE_MERGING = 231;
	public static final int DONG_BO_VMA_TRACKCHANGE = 232;
	public static final int DONG_BO_VMA_AUDIT = 233;
	public static final int DONG_BO_DM_SHIP_AGENCY = 234;
	public static final int DONG_BO_VMA_ITINERARY_REMARKS = 235;
	public static final int DONG_BO_VMA_ITINERARY_PROTEST = 236;
	
	public static final int[] DONG_BO_DM_MESSAGE_TYPES = new int[] { 
		DONG_BO_DM_VMA_TUGBOAT_COMPANY,DONG_BO_DM_HISTORY_TUGBOAT_COMPANY, DONG_BO_DM_VMA_TUGBOAT, DONG_BO_DM_HISTORY_TUGBOAT,
		DONG_BO_DM_VMA_PILOT_COMPANY, DONG_BO_DM_HISTORY_PILOT_COMPANY, DONG_BO_DM_VMA_PILOT,
		DONG_BO_DM_HISTORY_PILOT, DONG_BO_DM_VMA_PILOT_CATEGORY, DONG_BO_DM_HISTORY_PILOT_CATEGORY,
		DONG_BO_DM_VMA_SHIP_OWNER, DONG_BO_DM_HISTORY_SHIP_OWNER, DONG_BO_DM_VMA_SHIPYARD,
		DONG_BO_DM_HISTORY_SHIPYARD, DONG_BO_DM_VMA_SECURITY_OFFICE, DONG_BO_DM_HISTORY_SECURITY_OFFICE,
		DONG_BO_DM_VMA_SHIP_TYPE, DONG_BO_DM_HISTORY_VMASHIP_TYPE, DONG_BO_DM_SHIP_AGENCY, NHOM_DM_CANG_BIEN_HANG_HAI,
		DONG_BO_DM_QUOC_GIA, DONG_BO_DM_TINH_THANH, DONG_BO_DM_QUAN_HUYEN, DONG_BO_DM_CANG_BEN,
		DONG_BO_DM_KHU_VUC_CANG, DONG_BO_DM_BEN_CANG, DONG_BO_DM_CAU_CANG, DONG_BO_DM_CANG_HAI_QUAN,
		DONG_BO_DM_CANG_BIEN_HANG_HAI, DONG_BO_DM_HANG_HOA_HANG_HAI, DONG_BO_DM_CANG_VU_HANG_HAI
	};
	
	public static final int[] DONG_BO_VMA_MESSAGE_TYPES = new int[] { 
		DONG_BO_VMA_PILOT_VIOLATION, DONG_BO_VMA_SHIP,
		DONG_BO_VMA_SHIP_CERTIFICATE, DONG_BO_VMA_ITINERARY, DONG_BO_VMA_ITINERARY_SCHEDULE,
		DONG_BO_VMA_SCHEDULE_TUGBOAT, DONG_BO_VMA_SCHEDULE_PILOT, DONG_BO_VMA_SCHEDULE_SHIFTING,
		DONG_BO_VMA_SCHEDULE_ANCHORAGE, DONG_BO_VMA_SCHEDULE_SECURITY, DONG_BO_VMA_SCHEDULE_SHIPYARD,
		DONG_BO_VMA_SCHEDULE_LAUNCHING, DONG_BO_VMA_SCHEDULE_TESTING, DONG_BO_VMA_SCHEDULE_MERGING,
		DONG_BO_VMA_TRACKCHANGE, DONG_BO_VMA_AUDIT, DONG_BO_VMA_ITINERARY_REMARKS, DONG_BO_VMA_ITINERARY_PROTEST
	};
