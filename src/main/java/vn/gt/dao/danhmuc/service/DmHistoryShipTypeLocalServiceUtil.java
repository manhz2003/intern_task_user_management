 ...
 * @generated
 */
import com.fds.nsw.nghiepvu.danhmuc.service.impl.DmHistoryShipTypeLocalServiceImpl;
import org.springframework.stereotype.Component; @Component public class DmHistoryShipTypeLocalServiceUtil {
public DmHistoryShipTypeLocalServiceUtil(DmHistoryShipTypeLocalServiceImpl service) {
DmHistoryShipTypeLocalServiceUtil._service = service;
}
public static DmHistoryShipTypeLocalServiceImpl getService() {
return _service;
}
private static DmHistoryShipTypeLocalServiceImpl _service;
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	public static com.fds.nsw.nghiepvu.model.DmHistoryShipType addDmHistoryShipType(
		com.fds.nsw.nghiepvu.model.DmHistoryShipType dmHistoryShipType)
	...
	*/
	public static com.fds.nsw.nghiepvu.model.DmHistoryShipType createDmHistoryShipType(
		int id) {
	...
	*/
	...
	public static com.fds.nsw.nghiepvu.model.DmHistoryShipType fetchDmHistoryShipType(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.fds.nsw.nghiepvu.model.DmHistoryShipType getDmHistoryShipType(
		int id)
		throws com.fds.nsw.kernel.exception.PortalException,
			com.fds.nsw.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.fds.nsw.nghiepvu.model.DmHistoryShipType> getDmHistoryShipTypes(
		int start, int end)
		throws com.fds.nsw.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.fds.nsw.nghiepvu.model.DmHistoryShipType updateDmHistoryShipType(
		com.fds.nsw.nghiepvu.model.DmHistoryShipType dmHistoryShipType)
		throws com.fds.nsw.kernel.exception.SystemException {
	...
	*
	* @param dmHistoryShipType the dm history ship type
	* @param merge whether to merge the dm history ship type with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.fds.nsw.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	* @return the dm history ship type that was updated
	* @throws SystemException if a system exception occurred
	*/
	public static com.fds.nsw.nghiepvu.model.DmHistoryShipType updateDmHistoryShipType(
	...
	public static com.fds.nsw.nghiepvu.model.DmHistoryShipType findByShipTypeCodeAndSyncVersion(
