...
//				}
			...
			case PageType.ACTION_TYPE_KYSO:
				...
				if (Validator.isNotNull(issuePortClearance)) {
					...
					if(finish) {
						...
						dongDau(requestCode, documentName, documentYear, messageType, desStatus, user,
			...
			case PageType.ACTION_TYPE_DONGDAU:
				...
				dongDau(requestCode, documentName, documentYear, messageType, desStatus, user, uploadPortletRequest,
