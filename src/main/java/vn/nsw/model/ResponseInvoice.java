...
@XmlRootElement(name = "ResponseInvoice")
public class ResponseInvoice {
    ...
    protected List<ResponseInvoice.Invoice> invoice;
     ...
     * {@link ResponseInvoice.Invoice }
     * 
     * 
     */
    public List<ResponseInvoice.Invoice> getInvoice() {
        if (invoice == null) {
            invoice = new ArrayList<ResponseInvoice.Invoice>();
        }
        return this.invoice;
    }
    ...
    public static class Invoice {
        ...
        protected ResponseInvoice.Invoice.Products products;
         ...
         * @return
         *     possible object is
         *     {@link ResponseInvoice.Invoice.Products }
         *     
         */
        public ResponseInvoice.Invoice.Products getProducts() {
            return products;
        }
         ...
         *     
         */
        public void setProducts(ResponseInvoice.Invoice.Products value) {
            this.products = value;
        }
        ...
        public static class Products {
            ...
            protected List<ResponseInvoice.Invoice.Products.Product> product;
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link ResponseInvoice.Invoice.Products.Product }
             * 
             * 
             */
            public List<ResponseInvoice.Invoice.Products.Product> getProduct() {
                if (product == null) {
                    product = new ArrayList<ResponseInvoice.Invoice.Products.Product>();
                }
                return this.product;
            }
