...
import com.fds.nsw.nghiepvu.repository.DmHistoryPassportTypeRepository;
import com.fds.nsw.nghiepvu.modelImpl.DmHistoryPassportTypeModelImpl;
...
@Slf4j
@Service
public class DmHistoryPassportTypePersistenceImpl extends BasePersistence {
	@Autowired
	DmHistoryPassportTypeRepository repository;
	@Autowired
	@Qualifier("blQueryFactory")
	QueryFactory<DmHistoryPassportType> queryFactory;
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmHistoryPassportType create(int id) {
		DmHistoryPassportType dmHistoryPassportType = new DmHistoryPassportType();
	...
	public DmHistoryPassportType remove(Serializable primaryKey)
		...
		try {
			...
			DmHistoryPassportType dmHistoryPassportType = findByPrimaryKey(primaryKey);
			...
			repository.delete(dmHistoryPassportType);
			return dmHistoryPassportType;
		}
	...
	public DmHistoryPassportType remove(DmHistoryPassportType DmHistoryPassportType) throws SystemException {
	removeImpl(DmHistoryPassportType);	return DmHistoryPassportType;
}
...
(
	...
	public DmHistoryPassportType updateImpl(
		...
		try {
			...
			repository.saveAndFlush(dmHistoryPassportType);
	...
	public DmHistoryPassportType fetchByPrimaryKey(int id)
		...
		if (dmHistoryPassportType == null) {
			...
			try {
				...
				Optional<DmHistoryPassportType> optional = repository.findById(id);
				if (optional.isPresent()) {
					dmHistoryPassportType = optional.get();
				}
			}
			catch (Exception e) {
				hasException = true;
	...
	public List<DmHistoryPassportType> findByPassportTypeCode(
		...
		List<DmHistoryPassportType> list = null;
		if (list == null) {
			...
			try {
				...
				list = (List<DmHistoryPassportType>)queryFactory.getResultList(builder);
			}
			catch (Exception e) {
				throw processException(e);
			}
	...
	public DmHistoryPassportType[] findByPassportTypeCode_PrevAndNext(int id,
		...
		try {
			...
			DmHistoryPassportType[] array = new DmHistoryPassportType[3];
	...
	protected DmHistoryPassportType getByPassportTypeCode_PrevAndNext(
		...
		List<DmHistoryPassportType> list = queryFactory.getResultList(builder);
	...
	public DmHistoryPassportType fetchByPassportTypeCodeAndSyncVersion(
		...
		if (dmHistoryPassportType == null) {
			...
			try {
				...
				QueryBuilder builder = QueryBuilder.builder().sqlQuery(false).queryString(sql).entityClass(DmHistoryPassportType.class).build();
				...
				dmHistoryPassportType = (DmHistoryPassportType) queryFactory.getSingleResult(builder);
			}
			catch (Exception e) {
				throw processException(e);
			}
	...
	public int countAll() throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				QueryBuilder builder = QueryBuilder.builder().sqlQuery(false).queryString(_SQL_COUNT_DMHISTORYPASSPORTTYPE).build();
	...
	private static final String _FINDER_COLUMN_PASSPORTTYPECODE_PASSPORTTYPECODE_2 =
		"dmHistoryPassportType.passportTypeCode =:passportTypeCode";
	private static final String _FINDER_COLUMN_PASSPORTTYPECODE_PASSPORTTYPECODE_3 =
		"(dmHistoryPassportType.passportTypeCode IS NULL OR dmHistoryPassportType.passportTypeCode =:passportTypeCode)";
	...
	private static final String _FINDER_COLUMN_PASSPORTTYPECODEANDSYNCVERSION_PASSPORTTYPECODE_2 =
		"dmHistoryPassportType.passportTypeCode =:passportTypeCode AND ";
	private static final String _FINDER_COLUMN_PASSPORTTYPECODEANDSYNCVERSION_PASSPORTTYPECODE_3 =
		"(dmHistoryPassportType.passportTypeCode IS NULL OR dmHistoryPassportType.passportTypeCode =:passportTypeCode) AND ";
	...
	private static final String _FINDER_COLUMN_PASSPORTTYPECODEANDSYNCVERSION_SYNCVERSION_2 =
		"dmHistoryPassportType.syncVersion =:syncVersion";
	private static final String _FINDER_COLUMN_PASSPORTTYPECODEANDSYNCVERSION_SYNCVERSION_3 =
		"(dmHistoryPassportType.syncVersion IS NULL OR dmHistoryPassportType.syncVersion =:syncVersion)";
