...
public class DmPortWharfModelImpl {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a dm port wharf model instance should use the {@link com.fds.nsw.nghiepvu.model.DmPortWharf} interface instead.
	 */
