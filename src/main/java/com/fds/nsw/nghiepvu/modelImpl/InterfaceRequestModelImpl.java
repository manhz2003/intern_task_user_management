...
public class InterfaceRequestModelImpl {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a interface request model instance should use the {@link com.fds.nsw.nghiepvu.model.InterfaceRequest} interface instead.
	 */
