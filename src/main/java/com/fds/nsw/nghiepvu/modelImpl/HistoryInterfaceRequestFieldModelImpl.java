...
public class HistoryInterfaceRequestFieldModelImpl {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a history interface request field model instance should use the {@link com.fds.nsw.nghiepvu.model.HistoryInterfaceRequestField} interface instead.
	 */
