...
public class DmGtStatusModelImpl {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a dm gt status model instance should use the {@link com.fds.nsw.nghiepvu.model.DmGtStatus} interface instead.
	 */
