...
public class DmHistorySecurityLevelModelImpl {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a dm history security level model instance should use the {@link com.fds.nsw.nghiepvu.model.DmHistorySecurityLevel} interface instead.
	 */
