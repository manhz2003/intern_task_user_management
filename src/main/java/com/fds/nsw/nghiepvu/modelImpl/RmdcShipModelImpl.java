...
public class RmdcShipModelImpl {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a rmdc ship model instance should use the {@link com.fds.nsw.nghiepvu.model.RmdcShip} interface instead.
	 */
