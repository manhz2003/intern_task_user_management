...
public class DmHistoryUnitGeneralModelImpl {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a dm history unit general model instance should use the {@link com.fds.nsw.nghiepvu.model.DmHistoryUnitGeneral} interface instead.
	 */
