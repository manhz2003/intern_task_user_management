...
public class TempPersonListModelImpl {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a temp person list model instance should use the {@link com.fds.nsw.nghiepvu.model.TempPersonList} interface instead.
	 */
