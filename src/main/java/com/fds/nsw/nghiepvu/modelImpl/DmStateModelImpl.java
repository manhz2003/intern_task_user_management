...
public class DmStateModelImpl {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a dm state model instance should use the {@link com.fds.nsw.nghiepvu.model.DmState} interface instead.
	 */
