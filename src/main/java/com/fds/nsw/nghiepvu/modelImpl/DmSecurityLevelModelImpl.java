...
public class DmSecurityLevelModelImpl {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a dm security level model instance should use the {@link com.fds.nsw.nghiepvu.model.DmSecurityLevel} interface instead.
	 */
