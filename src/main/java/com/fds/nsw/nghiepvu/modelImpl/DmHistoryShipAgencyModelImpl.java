...
public class DmHistoryShipAgencyModelImpl {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a dm history ship agency model instance should use the {@link com.fds.nsw.nghiepvu.model.DmHistoryShipAgency} interface instead.
	 */
