...
public class DmGtOrganizationModelImpl {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a dm gt organization model instance should use the {@link com.fds.nsw.nghiepvu.model.DmGtOrganization} interface instead.
	 */
