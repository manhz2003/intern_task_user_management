...
public class DmArrivalPurposeModelImpl {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a dm arrival purpose model instance should use the {@link com.fds.nsw.nghiepvu.model.DmArrivalPurpose} interface instead.
	 */
