...
@Setter
@Entity
@Table(name = "vma_ship", schema = "dvc_hanghai_nghiepvu_clone")
...
private Long id=0L;
    ...
    @ColumnDefault("0.00")
    @Column(name = "Craneload", precision = 18, scale = 2)
    private BigDecimal craneload;

    @ColumnDefault("'MTs'")
    @Column(name = "UnitCraneload", length = 10)
    private String unitCraneload;
    ...
    @Column(name = "SyncVersion", length = 50)
