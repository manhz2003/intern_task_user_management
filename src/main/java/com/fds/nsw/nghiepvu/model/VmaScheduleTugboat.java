...
@Setter
@Entity
@Table(name = "vma_schedule_tugboat", schema = "dvc_hanghai_nghiepvu_clone")
public class VmaScheduleTugboat {
    @Id
...
private Long id=0L;
    ...
    @Column(name = "TugDateFrom")
    private Date tugDateFrom;

    @Column(name = "TugDateTo")
    private Date tugDateTo;
