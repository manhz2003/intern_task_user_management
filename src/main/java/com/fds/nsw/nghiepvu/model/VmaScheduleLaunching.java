...
@Setter
@Entity
@Table(name = "vma_schedule_launching", schema = "dvc_hanghai_nghiepvu_clone")
...
private Long id=0L;
    ...
    @Column(name = "LaunchingFrom")
    private Date launchingFrom;

    @Column(name = "LaunchingTo")
    private Date launchingTo;

    @Column(name = "LaunchingPlace")
    private String launchingPlace;

    @Lob
    @Column(name = "LaunchingReason")
    private String launchingReason;
