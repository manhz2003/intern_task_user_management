...
import com.fds.nsw.nghiepvu.repository.TempCargoItemRepository;
import com.fds.nsw.nghiepvu.modelImpl.TempCargoItemsModelImpl;
...
@Slf4j
@Service
public class TempCargoItemsPersistenceImpl extends BasePersistence {
	@Autowired
	TempCargoItemRepository repository;
	@Autowired
	@Qualifier("blQueryFactory")
	QueryFactory<TempCargoItems> queryFactory;
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public TempCargoItems create(long id) {
		TempCargoItems tempCargoItems = new TempCargoItems();
	...
	public TempCargoItems remove(Serializable primaryKey)
		...
		try {
			...
			TempCargoItems tempCargoItems = findByPrimaryKey(primaryKey);
			...
			repository.delete(tempCargoItems);
			return tempCargoItems;
		}
	...
	public TempCargoItems remove(TempCargoItems TempCargoItems) throws SystemException {
	removeImpl(TempCargoItems);
	return TempCargoItems;
}
...
protected TempCargoItems removeImpl(TempCargoItems tempCargoItems)
	...
	public TempCargoItems updateImpl(
		...
		try {
			...
			repository.saveAndFlush(tempCargoItems);
	...
	public TempCargoItems fetchByPrimaryKey(long id) throws SystemException {
		...
		if (tempCargoItems == null) {
			...
			try {
				...
				Optional<TempCargoItems> optional = repository.findById(id);
				if (optional.isPresent()) {
					tempCargoItems = optional.get();
				}
			}
			catch (Exception e) {
				hasException = true;
	...
	public List<TempCargoItems> findBydocumentNameAnddocumentYear(
		...
		if (list == null) {
			...
			try {
				...
				list = (List<TempCargoItems>)queryFactory.getResultList(builder);
			}
			catch (Exception e) {
				throw processException(e);
			}
	...
	public TempCargoItems findBydocumentNameAnddocumentYear_First(
		...
		throws NoSuchTempCargoItemsException, SystemException {
		TempCargoItems tempCargoItems = fetchBydocumentNameAnddocumentYear_First(documentName,
	 ...
	 * @param documentYear the document year
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching temp cargo items, or <code>null</code> if a matching temp cargo items could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public TempCargoItems fetchBydocumentNameAnddocumentYear_First(
		long documentName, int documentYear, OrderByComparator orderByComparator)
		throws SystemException {
	...
	public TempCargoItems findBydocumentNameAnddocumentYear_Last(
		long documentName, int documentYear, OrderByComparator orderByComparator)
		throws NoSuchTempCargoItemsException, SystemException {
		TempCargoItems tempCargoItems = fetchBydocumentNameAnddocumentYear_Last(documentName,
				documentYear, orderByComparator);
	 ...
	 * @param documentYear the document year
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching temp cargo items, or <code>null</code> if a matching temp cargo items could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public TempCargoItems fetchBydocumentNameAnddocumentYear_Last(
		long documentName, int documentYear, OrderByComparator orderByComparator)
		throws SystemException {
	...
	public TempCargoItems[] findBydocumentNameAnddocumentYear_PrevAndNext(
		...
		try {
			...
			TempCargoItems[] array = new TempCargoItems[3];
	...
	protected TempCargoItems getBydocumentNameAnddocumentYear_PrevAndNext(
		 TempCargoItems tempCargoItems, long documentName,
		...
		List<TempCargoItems> list = queryFactory.getResultList(builder);
	...
	public TempCargoItems findBydocumentNameAnddocumentYearAndRequestCode_First(
		...
		OrderByComparator orderByComparator)
		throws NoSuchTempCargoItemsException, SystemException {
		TempCargoItems tempCargoItems = fetchBydocumentNameAnddocumentYearAndRequestCode_First(documentName,
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempCargoItems fetchBydocumentNameAnddocumentYearAndRequestCode_First(
		long documentName, int documentYear, String requestCode,
		OrderByComparator orderByComparator) throws SystemException {
	...
	public TempCargoItems findBydocumentNameAnddocumentYearAndRequestCode_Last(
		...
		OrderByComparator orderByComparator)
		throws NoSuchTempCargoItemsException, SystemException {
		TempCargoItems tempCargoItems = fetchBydocumentNameAnddocumentYearAndRequestCode_Last(documentName,
				documentYear, requestCode, orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempCargoItems fetchBydocumentNameAnddocumentYearAndRequestCode_Last(
		long documentName, int documentYear, String requestCode,
		OrderByComparator orderByComparator) throws SystemException {
	...
	public TempCargoItems findByRequestCode_First(String requestCode,
		OrderByComparator orderByComparator)
		throws NoSuchTempCargoItemsException, SystemException {
		TempCargoItems tempCargoItems = fetchByRequestCode_First(requestCode,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempCargoItems fetchByRequestCode_First(String requestCode,
		OrderByComparator orderByComparator) throws SystemException {
	...
	public TempCargoItems findByRequestCode_Last(String requestCode,
		OrderByComparator orderByComparator)
		throws NoSuchTempCargoItemsException, SystemException {
		TempCargoItems tempCargoItems = fetchByRequestCode_Last(requestCode,
				orderByComparator);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public TempCargoItems fetchByRequestCode_Last(String requestCode,
		OrderByComparator orderByComparator) throws SystemException {
	...
	public TempCargoItems[] findByRequestCode_PrevAndNext(long id,
		...
		try {
			...
			array[0] = getByRequestCode_PrevAndNext(tempCargoItems,
					requestCode, orderByComparator, true);

			array[1] = tempCargoItems;

			array[2] = getByRequestCode_PrevAndNext(tempCargoItems,
	...
	protected TempCargoItems getByRequestCode_PrevAndNext(
	...
	public int countAll() throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				QueryBuilder builder = QueryBuilder.builder().sqlQuery(false).queryString(_SQL_COUNT_TEMPCARGOITEMS).build();
	...
	private static final String _FINDER_COLUMN_DOCUMENTNAMEANDDOCUMENTYEAR_DOCUMENTNAME_2 =
		"tempCargoItems.documentName =:documentName AND ";
	private static final String _FINDER_COLUMN_DOCUMENTNAMEANDDOCUMENTYEAR_DOCUMENTYEAR_2 =
		"tempCargoItems.documentYear =:documentYear";
	...
	private static final String _FINDER_COLUMN_DOCUMENTNAMEANDDOCUMENTYEARANDREQUESTCODE_DOCUMENTYEAR_2 =
		"tempCargoItems.documentYear =:documentYear AND ";
	...
	private static final String _FINDER_COLUMN_DOCUMENTNAMEANDDOCUMENTYEARANDREQUESTCODE_REQUESTCODE_2 =
		"tempCargoItems.requestCode =:requestCode";
	private static final String _FINDER_COLUMN_DOCUMENTNAMEANDDOCUMENTYEARANDREQUESTCODE_REQUESTCODE_3 =
		"(tempCargoItems.requestCode IS NULL OR tempCargoItems.requestCode =:requestCode)";
	private static final String _FINDER_COLUMN_REQUESTCODE_REQUESTCODE_1 = "tempCargoItems.requestCode IS NULL";
	private static final String _FINDER_COLUMN_REQUESTCODE_REQUESTCODE_2 = "tempCargoItems.requestCode =:requestCode";
	private static final String _FINDER_COLUMN_REQUESTCODE_REQUESTCODE_3 = "(tempCargoItems.requestCode IS NULL OR tempCargoItems.requestCode =:requestCode)";
