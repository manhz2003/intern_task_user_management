...
import com.fds.nsw.nghiepvu.repository.TempGeneralDeclarationRepository;
import com.fds.nsw.nghiepvu.modelImpl.TempGeneralDeclarationModelImpl;
...
@Slf4j
@Service
public class TempGeneralDeclarationPersistenceImpl extends BasePersistence {
	@Autowired
	TempGeneralDeclarationRepository repository;
	@Autowired
	...
	public TempGeneralDeclaration create(long id) {
		TempGeneralDeclaration tempGeneralDeclaration = new TempGeneralDeclaration();
	...
	public TempGeneralDeclaration remove(Serializable primaryKey)
		...
		try {
			...
			TempGeneralDeclaration tempGeneralDeclaration = findByPrimaryKey(primaryKey);
			...
			repository.delete(tempGeneralDeclaration);
			return tempGeneralDeclaration;
		}
	...
	public TempGeneralDeclaration remove(TempGeneralDeclaration TempGeneralDeclaration) throws SystemException {
	removeImpl(TempGeneralDeclaration);
	return TempGeneralDeclaration;
}
...
protected TempGeneralDeclaration removeImpl(
	...
	public TempGeneralDeclaration updateImpl(
		...
		try {
			...
			repository.saveAndFlush(tempGeneralDeclaration);
	...
	public TempGeneralDeclaration fetchByPrimaryKey(long id)
		...
		if (tempGeneralDeclaration == null) {
			...
			try {
				...
				Optional<TempGeneralDeclaration> optional = repository.findById(id);
				if (optional.isPresent()) {
					tempGeneralDeclaration = optional.get();
				}
			}
			catch (Exception e) {
				hasException = true;
	...
	public List<TempGeneralDeclaration> findByDocumentNameAndDocumentYear(
		...
		List<TempGeneralDeclaration> list = null;
		if (list == null) {
			...
			try {
				...
				list = (List<TempGeneralDeclaration>)queryFactory.getResultList(builder);
			}
			catch (Exception e) {
				throw processException(e);
			}
	...
	public TempGeneralDeclaration[] findByDocumentNameAndDocumentYear_PrevAndNext(
		...
		try {
			...
			TempGeneralDeclaration[] array = new TempGeneralDeclaration[3];
	...
	protected TempGeneralDeclaration getByDocumentNameAndDocumentYear_PrevAndNext(
		...
		List<TempGeneralDeclaration> list = queryFactory.getResultList(builder);
	...
	public int countAll() throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				QueryBuilder builder = QueryBuilder.builder().sqlQuery(false).queryString(_SQL_COUNT_TEMPGENERALDECLARATION).build();
	...
	private static final String _FINDER_COLUMN_DOCUMENTNAMEANDDOCUMENTYEAR_DOCUMENTNAME_2 =
		"tempGeneralDeclaration.documentName =:documentName AND ";
	private static final String _FINDER_COLUMN_DOCUMENTNAMEANDDOCUMENTYEAR_DOCUMENTYEAR_2 =
		"tempGeneralDeclaration.documentYear =:documentYear";
	...
	private static final String _FINDER_COLUMN_DOCUMENTNAMEANDDOCUMENTYEARREQUESTSTATE_DOCUMENTYEAR_2 =
		"tempGeneralDeclaration.documentYear =:documentYear AND ";
	private static final String _FINDER_COLUMN_DOCUMENTNAMEANDDOCUMENTYEARREQUESTSTATE_REQUESTSTATE_2 =
		"tempGeneralDeclaration.requestState =:requestState";
	private static final String _FINDER_COLUMN_REQUESTCODE_REQUESTCODE_1 = "tempGeneralDeclaration.requestCode IS NULL";
	private static final String _FINDER_COLUMN_REQUESTCODE_REQUESTCODE_2 = "tempGeneralDeclaration.requestCode =:requestCode";
	private static final String _FINDER_COLUMN_REQUESTCODE_REQUESTCODE_3 = "(tempGeneralDeclaration.requestCode IS NULL OR tempGeneralDeclaration.requestCode =:requestCode)";
