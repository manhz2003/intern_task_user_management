...
import com.fds.nsw.nghiepvu.noticeandmessage.service.persistence.TempShipStoresItemsPersistenceImpl;
...
public class TempShipStoresItemsLocalServiceImpl
	{ @Autowired
	TempShipStoresItemsPersistenceImpl persistence;
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public List<TempShipStoresItems> findTempShipStoresItemsByRequestCode(String requestCode) {
		...
		public TempShipStoresItems addTempShipStoresItems(
			...
			tempShipStoresItems = persistence.updateImpl(tempShipStoresItems,
					false);
		...
		public void deleteTempShipStoresItems(long id)
			...
			TempShipStoresItems tempShipStoresItems = persistence.remove(id);
		...
		public void deleteTempShipStoresItems(
				TempShipStoresItems tempShipStoresItems) throws SystemException {
			persistence.remove(tempShipStoresItems);
		 ...
		 *
		 * @param tempShipStoresItems the temp ship stores items
		 * @param merge whether to merge the temp ship stores items with the current session. See  for an explanation.
		 * @return the temp ship stores items that was updated
		 * @throws SystemException if a system exception occurred
		 */
		public TempShipStoresItems updateTempShipStoresItems(
